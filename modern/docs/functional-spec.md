...
| DSLT/Sobel-like | radius, geodesic direction level, Z factor, C sweep, mean/Gaussian kernel | radius 14, level 2, Z factor 0.2, mean | Scalar CPU threshold basis implemented; full directional oracle fixtures, closing, and iterative sweep pending |
